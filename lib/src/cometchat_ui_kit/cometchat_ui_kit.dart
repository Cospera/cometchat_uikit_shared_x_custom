...
class CometChatUIKit {
 ...
 static _inititalizeTimeZoneDetails() {
  ...
  static Future<BaseMessage?> addReaction(int messageId, String reaction, {dynamic Function(BaseMessage)? onSuccess, dynamic Function(CometChatException)? onError, }) async{
  ...
  static Future<BaseMessage?> removeReaction(int messageId, String reaction, {dynamic Function(BaseMessage)? onSuccess, dynamic Function(CometChatException)? onError, }) async{
